#* ---------------------------------------------------------------
# *      File : dav_multicast.py 
# *      Name : Nakul Shah 
# * 
# *      Description: This file contains script to dump dav hw tables. 
# *
...
print("M=dav_multicast.dump(_mod=1, _unit = 0, _print_out=1)");
print("M.help()")
...
class dump:    
    ...
    def ovtbl(self, _slice = 0, _index = 0):
        ...
        if self.print_out== 1:
            ...
            port_list = temp_str.split(":")[0]
            port_list = int(port_list, 0)
            i = 0 
            while True:
                bit = 1 << i
                if(port_list & bit):
                    port_bits.append(i+32)
                i = i + 1
                if(i == 32):
                    break
